...
namespace AuctionService.IntegrationTests
{
    ...
    public class AuctionControllerTests : IAsyncLifetime
    {
        ...
        [Fact]
        public async Task GetAuctionById_WithValidIdShouldReturnAuctions()
        {
            // arrange
        ...
        public async Task CreateAuction_WithAuth_ShouldReturn201()
        {
            ...
            // assert
            response.EnsureSuccessStatusCode(); // That means that we're getting something that's not a failure request.
